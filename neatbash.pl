...
#::    -f  -- write formatted test into the same files creating backup
#::    -p -- work as a pipe
#::    -v --  provide additional warnings about non-balance of quotes and round parentheses
#::
#::
#::  PARAMETERS
#::
